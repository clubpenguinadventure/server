...
export default class Get extends GamePlugin {
    ...
    async getStampbookData(args, user) {
        ...
        if (u) {
            user.send('get_stampbook_data', { stamps, color: u.stampbookColor, pattern: u.stampbookPattern, highlight: u.stampbookHighlight, clasp: u.stampbookClasp, nickname: u.nickname })
        }
    }
